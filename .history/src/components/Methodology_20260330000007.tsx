...
const statuses = [
  { key: 'not_started', tKey: 'notStartedDesc', icon: <Circle size={18} />, color: '#6b7280' },
  { key: 'in_progress', tKey: 'inProgressDesc', icon: <Loader size={18} />, color: '#3b82f6' },
  { key: 'completed', tKey: 'completedDesc', icon: <CheckCircle2 size={18} />, color: '#10b981' },
  { key: 'broken', tKey: 'brokenDesc', icon: <XCircle size={18} />, color: '#ef4444' },
  { key: 'stalled', tKey: 'stalledDesc', icon: <Pause size={18} />, color: '#f59e0b' },
];
