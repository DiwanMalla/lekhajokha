    ...
    <div className="flex items-center gap-3 justify-center mt-8">
      {[
        ...
        <div key={i} className="flex flex-col items-center">
          <div className="glass-card rounded-xl px-5 py-3 min-w-18 text-center">
            <span className="text-3xl font-extrabold tabular-nums">
              {String(item.value).padStart(2, "0")}
            </span>
          </div>
          <span className="text-xs mt-1.5 font-semibold uppercase tracking-widest text-(--muted)">
            {item.label}
          </span>
...
export default function Hero() {
  ...
  return (
    <section className="relative pt-20 pb-16 md:pt-28 md:pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-b from-blue-50/70 via-amber-50/30 to-transparent dark:from-blue-950/20 dark:via-amber-950/10 pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-(--border) bg-(--card) mb-6 shadow-sm"
          >
          ...
          >
            <p className="text-sm font-semibold uppercase tracking-widest text-(--muted) mt-8 mb-1">
