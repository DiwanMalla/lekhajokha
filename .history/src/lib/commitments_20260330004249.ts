...
const raw: RawCommitment[] = [
  ...
  },
  {
    point: 49,
    categoryId: "F",
    title_en: "Create national project pipeline and project facilitation mechanism",
    ...
    sub_commitments: [
      {
        ...
        title_ne: "लगानीको ढाँचा सहितको राष्ट्रिय परियोजना बैंक (पाइपलाइन) निर्माण",
        deadline_days: 60,
        status: "not_started"
      },
      {
      ...
      {
        title_en: "Establish Fast-Track Mechanism for National Pride projects (land, EIA)",
        title_ne: "राष्ट्रिय गौरवका आयोजनाका लागि फास्ट ट्र्याक संयन्त्र (जग्गा प्राप्ति, EIA)",
        deadline_days: null,
        status: "not_started"
      },
      {
        title_en: "Draft law to execute twice-failed bidding projects via govt infrastructure company",
        title_ne: "दुई पटक ठेक्का नलागेका आयोजना सरकारी पूर्वाधार कम्पनीबाट अघि बढाउने कानुन मस्यौदा",
        deadline_days: 30,
        status: "not_started"
      }
    ]
  ...
  },
  {
    point: 69,
    categoryId: "G",
    title_en: "Implement SME protection strategy and business rehabilitation mechanism",
    ministry: "Industry, Commerce & Supplies",
    deadline_type: "ongoing",
    deadline_days: null,
    sub_commitments: [
      ...
      {
        title_en: "Prioritize administrative facilitation for disrupted businesses",
      ...
      },
      {
        ...
        title_ne: "प्रधानमन्त्रीको अध्यक्षतामा रहेको उद्योग–वाणिज्य संवाद परिषद् सक्रिय बनाउने",
        deadline_days: 0,
        status: "not_started"
      }
    ]
...

  {
    point: 74,
    categoryId: "H",
    title_en: "Multi-dimensional energy export, PPA strategy and institutional reform",
    ministry: "Energy, Water Resources & Irrigation",
    deadline_type: "months",
    deadline_days: 30,
    sub_commitments: [
      { title_en: "Finalize national energy export strategy", title_ne: "राष्ट्रिय ऊर्जा निर्यात रणनीतिलाई अन्तिम रूप दिने", deadline_days: 30, status: "not_started" },
      { title_en: "Decide all pending power purchase agreements (PPAs)", title_ne: "प्रतीक्षामा रहेका सबै विद्युत् खरिद सम्झौता (PPA) को निर्णय गर्ने", deadline_days: 180, status: "not_started" },
      { title_en: "Focus electricity export on high-value peak-hour markets", title_ne: "पिक-आवरको उच्च मूल्य बजारमा विद्युत् निर्यातमा केन्द्रित हुने", deadline_days: 0, status: "not_started" },
      { title_en: "Implement NEA structural reform roadmap", title_ne: "नेपाल विद्युत् प्राधिकरणको संरचनागत सुधार मार्गचित्र कार्यान्वयन", deadline_days: 0, status: "not_started" },
      { title_en: "Establish multi-dimensional financing structure for energy", title_ne: "ऊर्जाको लागि बहुआयामिक वित्तपोषण संरचना स्थापना", deadline_days: null, status: "not_started" }
    ]
  },
  {
    point: 75,
    categoryId: "H",
    title_en: "Create Kathmandu water and sewage high-level coordination taskforce",
  ...
  },
  {
    point: 76,
    categoryId: "H",
    title_en: "Protect Phewa Lake through encroachment removal and watershed conservation",
...

  {
    point: 78,
    categoryId: "I",
    title_en: "Transfer money from inactive 10+ year bank accounts to state treasury",
    ministry: "Finance",
    deadline_type: "days",
    deadline_days: 90,
  },
  ...
  },
  {
    point: 81,
    categoryId: "I",
    title_en: "Consolidate scattered funds into high-return development projects",
    ministry: "Finance",
    deadline_type: "days",
    deadline_days: 60,
  },
  ...
  },
  {
    point: 84,
    categoryId: "I",
    title_en: "Create legal basis to use dormant court and government deposits for development",
    ministry: "Law, Justice & Parliamentary Affairs",
    deadline_type: "days",
    deadline_days: 60,
  },

  {
    point: 85,
    categoryId: "J",
    title_en: "Enforce free-bed quota, Free Health Portal, and upgrade hospital facilities",
    ministry: "Health & Population",
    deadline_type: "days",
    deadline_days: 30,
    sub_commitments: [
      { title_en: "Enforce 10% free bed quota and launch Free Health Portal", title_ne: "१०% निःशुल्क शय्या र निःशुल्क स्वास्थ्य पोर्टल", deadline_days: 30, status: "not_started" },
      { title_en: "Digital Patient Record System and Refer Protocol", title_ne: "डिजिटल बिरामी रेकर्ड र रिफर प्रोटोकल", deadline_days: 90, status: "not_started" },
      { title_en: "Hospital attendance monitoring and cleanliness audit", title_ne: "अस्पताल हाजिरी अनुगमन र सरसफाई अडिट", deadline_days: 7, status: "not_started" },
      { title_en: "Digital pharmacy stock/price display and 'Sulav Pharmacy'", title_ne: "सुलभ फार्मेसी र डिजिटल स्टक/मूल्य प्रदर्शन", deadline_days: 100, status: "not_started" },
      { title_en: "Establish Burn Ward in most hospitals for subsidized treatment", title_ne: "अस्पतालहरूमा बर्न वार्ड स्थापना", deadline_days: 30, status: "not_started" },
      { title_en: "Ensure Air Ambulance on standby in remote hill regions", title_ne: "दुर्गम पहाडी क्षेत्रमा एयर एम्बुलेन्स स्ट्यान्डबाय", deadline_days: 0, status: "not_started" }
    ]
  },
  {
    point: 86,
    categoryId: "J",
    title_en: "Replace political student unions with non-partisan Student Councils",
    ministry: "Education, Science & Technology",
    deadline_type: "days",
    deadline_days: 90,
  },
  {
    point: 87,
    categoryId: "J",
    title_en: "Synchronize university exam result publication with academic calendar",
    ministry: "Education, Science & Technology",
    deadline_type: "ongoing",
    deadline_days: null,
  },
  ...
  },
  {
    point: 89,
    categoryId: "J",
    title_en: "Replace internal exams up to Grade 5 with psychological assessment",
    ministry: "Education, Science & Technology",
    deadline_type: "fiscal_year",
    deadline_days: 365,
  },

  {
    point: 90,
    categoryId: "K",
    title_en: "Fix minimum support prices for major crops and ensure timely payments",
    ministry: "Agriculture & Livestock Development",
    deadline_type: "days",
    deadline_days: 30,
    sub_commitments: [
      { title_en: "Fix Minimum Support Price for major crops", title_ne: "मुख्य बालीहरूको न्यूनतम समर्थन मूल्य तोक्ने", deadline_days: 30, status: "not_started" },
      { title_en: "Mandatory payment within 25 days and cold storage feasibility", title_ne: "२५ दिनभित्र भुक्तानी र शीत भण्डार सम्भाव्यता", deadline_days: 10, status: "not_started" },
      { title_en: "Issue Soil Health Card for commercial farmers", title_ne: "व्यावसायिक किसानका लागि माटो स्वास्थ्य कार्ड", deadline_days: 90, status: "not_started" }
    ]
  },
  {
    point: 91,
    categoryId: "K",
    title_en: "Digitize landless records in 60 days and resolve within 1,000 days",
  ...
  },
  {
    point: 92,
    categoryId: "K",
    title_en: "Remove encroachment on public land and investigate Nepal Bal Sangathan per Haribaboo report",
    ministry: "Home Affairs",
    deadline_type: "immediate",
    deadline_days: 15,
  },
  ...
  },
  {
    point: 95,
    categoryId: "L",
    title_en: "Form inter-ministerial taskforce to study Middle East crisis impacts",
  ...
  },
  {
    point: 97,
    categoryId: "L",
    title_en: "Launch free Blue Bus service in all 7 provinces with 25 buses in 100 days",
    ministry: "Physical Infrastructure & Transport",
    deadline_type: "days",
    deadline_days: 100,
  },
  {
    point: 98,
    categoryId: "L",
    title_en: "Mandate CCTV and dashcams in public transport with SOS integration",
    ministry: "Physical Infrastructure & Transport",
    deadline_type: "days",
    deadline_days: 30,
  },
  {
    point: 99,
    categoryId: "L",
    title_en: "Start refund process for small depositors in troubled cooperatives",
    ministry: "Land Management, Cooperatives & Poverty Alleviation",
    deadline_type: "days",
    deadline_days: 100,
  },
  {
    point: 100,
    categoryId: "L",
    title_en: "National Unity Call: Appeal to all stakeholders to cooperate in fulfilling national duties",
    ministry: "Prime Minister's Office",
    deadline_type: "ongoing",
    deadline_days: null,
  }
...
export const commitments: Commitment[] = raw.map((item) => {
  ...
  const ministryNe = item.responsible_ministry_ne ?? ministryLabel(ministryEn, "ne");
