...
const raw: RawCommitment[] = [
  ...
  },
  {
    point: 34,
    categoryId: "D",
    title_en: "Implement desk-time alert system for delayed file movement in GIOMS",
    ministry: "Prime Minister's Office",
    deadline_type: "days",
    deadline_days: 30,
  },
  ...
  },
  {
    ...
    categoryId: "F",
    title_en:
      "Create national project pipeline with clear investment modalities",
  ...
  },
  {
    ...
    categoryId: "G",
    title_en:
      "Prepare SME protection strategy for disruptions and supply risks",
    ministry: "Industry, Commerce & Supplies",
    deadline_type: "ongoing",
    deadline_days: null,
  },
...

  {
    point: 86,
    categoryId: "J",
    title_en: "Enforce free-bed quota and launch Free Health Portal",
  ...
  },
  {
    ...
    categoryId: "K",
    title_en:
      "Run special campaign to remove illegal encroachment on public land",
    ministry: "Home Affairs",
    deadline_type: "immediate",
    deadline_days: 0,
  },
...
export const commitments: Commitment[] = raw.map((item) => {
  ...
  return {
    ...
    title_ne: item.title_ne ?? `बुँदा ${item.point}: ${item.title_en}`,
    description_en: item.title_en,
    description_ne: item.title_ne ?? `बुँदा ${item.point} को प्रतिबद्धता: ${item.title_en}`,
